										...
										<fieldset style="height: 100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1"
												...
												<tr>
													...
													<td width="27%">
														<input name='name' type="text" class="text" id="name" readonly="readonly"
												...
												<tr>
													...
													<td colspan="3">
														<textarea name="other" id="other" readonly="readonly" cols="100" rows="20">${requestScope.onepost.other } </textarea>
													</td>
												</tr>
											</table>
											<br />
