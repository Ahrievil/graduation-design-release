...
dTree.prototype.add = function(id, pid, name, check, value, formName,checkBoxTitle, url,
	...
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, check, value,formName,checkBoxTitle, url, title, target, icon, iconOpen, open);
};
...
dTree.prototype.toString = function() {
	...
	//document.getElementById -> undefined false appendChild
